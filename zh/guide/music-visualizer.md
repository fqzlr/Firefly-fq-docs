...
音乐可视化页面的访问路径为 `/music/`，前提是在 [siteConfig.ts](file:///e:/AItool/zzwork/my-blog/src/config/siteConfig.ts) 中开启了音乐页面：
...
页面入口组件：[music/index.astro](file:///e:/AItool/zzwork/my-blog/src/pages/music/index.astro)
...
音乐可视化功能位于 [src/components/features/music-visualizer/](file:///e:/AItool/zzwork/my-blog/src/components/features/music-visualizer/) 目录下：
...
| 文件 | 职责 |
|------|------|
| [MusicVisualizer.svelte](file:///e:/AItool/zzwork/my-blog/src/components/features/music-visualizer/MusicVisualizer.svelte) | 主容器组件，负责连接音频分析器和 3D 场景，管理主题同步 |
| [AudioAnalyzer.ts](file:///e:/AItool/zzwork/my-blog/src/components/features/music-visualizer/AudioAnalyzer.ts) | Web Audio API 封装，实时音频频谱分析、节拍检测 |
| [ThreeScene.svelte](file:///e:/AItool/zzwork/my-blog/src/components/features/music-visualizer/ThreeScene.svelte) | Three.js 3D 场景渲染，地形波浪、粒子、光照等视觉效果 |
| [LyricsOverlay.svelte](file:///e:/AItool/zzwork/my-blog/src/components/features/music-visualizer/LyricsOverlay.svelte) | 歌词叠加显示组件 |
| [VisualizerControls.svelte](file:///e:/AItool/zzwork/my-blog/src/components/features/music-visualizer/VisualizerControls.svelte) | 音乐播放控制面板 |
| [music-visualizer.css](file:///e:/AItool/zzwork/my-blog/src/styles/pages/music-visualizer.css) | 页面样式文件 |

## 音频分析引擎

[AudioAnalyzer.ts](file:///e:/AItool/zzwork/my-blog/src/components/features/music-visualizer/AudioAnalyzer.ts) 是可视化的核心，负责从音频元素中提取频谱数据。
...
主题同步逻辑在 [MusicVisualizer.svelte](file:///e:/AItool/zzwork/my-blog/src/components/features/music-visualizer/MusicVisualizer.svelte) 中实现：
...
视觉效果参数主要在 [ThreeScene.svelte](file:///e:/AItool/zzwork/my-blog/src/components/features/music-visualizer/ThreeScene.svelte) 中定义，可以调整以下参数：
...
::: tip 保持播放
全站音乐播放器由 [MusicManager.astro](file:///e:/AItool/zzwork/my-blog/src/components/features/MusicManager.astro) 管理，会在页面加载时初始化。3D 可视化页面连接到同一个全局管理器实例。
:::
...
| 文件 | 说明 |
|------|------|
| [MusicVisualizer.svelte](file:///e:/AItool/zzwork/my-blog/src/components/features/music-visualizer/MusicVisualizer.svelte) | 可视化主组件 |
| [AudioAnalyzer.ts](file:///e:/AItool/zzwork/my-blog/src/components/features/music-visualizer/AudioAnalyzer.ts) | 音频分析引擎 |
| [ThreeScene.svelte](file:///e:/AItool/zzwork/my-blog/src/components/features/music-visualizer/ThreeScene.svelte) | Three.js 3D 场景 |
| [LyricsOverlay.svelte](file:///e:/AItool/zzwork/my-blog/src/components/features/music-visualizer/LyricsOverlay.svelte) | 歌词叠加层 |
| [VisualizerControls.svelte](file:///e:/AItool/zzwork/my-blog/src/components/features/music-visualizer/VisualizerControls.svelte) | 播放控制面板 |
| [music/index.astro](file:///e:/AItool/zzwork/my-blog/src/pages/music/index.astro) | 音乐页面路由 |
| [music-visualizer.css](file:///e:/AItool/zzwork/my-blog/src/styles/pages/music-visualizer.css) | 页面样式 |
| [MusicManager.astro](file:///e:/AItool/zzwork/my-blog/src/components/features/MusicManager.astro) | 全局音乐管理器 |
